  ...
  return (
    <main className="min-h-screen">
      ...
      {(openCreation || showModal) && (
        ...
        >
          <div
            className={`relative w-full max-w-2xl max-h-[85vh] sm:max-h-none overflow-y-auto rounded-2xl bg-white p-4 shadow-xl transform-gpu transition-all duration-150 ${showModal ? "opacity-100 scale-100" : "opacity-0 scale-95"
              }`}
